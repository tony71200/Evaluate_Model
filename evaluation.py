...
if __name__ == "__main__":
    directory = r'D:\Master\02_Project\LUNA16\evaluationModel\LUNA16_TestSubset2'
    GT_folder = "000_GroundTruth"
    Model_folder = "002_TestSubset2_V2"
    jsonFile = "resultTestLuna16_v2.json"
    eval = Evaluation(directory, GT_folder, Model_folder)
    json_path = os.path.join(directory, Model_folder, jsonFile)
    ...
    for conf in CONF_THRESH:
        ...
        eval.writetxt(os.path.join(path_conf_folder, 'result.txt'))
        eval.clearValue()
